...
<br> • `STRING_SESSION` - Hangi hesabın müzik çalmasını istiyorsanız o hesabın numarası ile Pyrogram tabanlı string session alın. Aşağı kaydırıp gereken değeri nasıl alabilirsiniz yazıyor orada.

## Basit bir sesli sohbet müzik çalma userbot
<br> • Basit ve kararlı.
<br> • Süre sınırı yok.
